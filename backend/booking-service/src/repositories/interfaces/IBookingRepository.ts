...
export interface IBookingRepository {
    ...
    cancelBooking(bookingId: string, session?: mongoose.ClientSession): Promise<void>;
    ...
    updateEvent(id: string, event: Partial<IEvent>, session?: mongoose.ClientSession): Promise<void>;
