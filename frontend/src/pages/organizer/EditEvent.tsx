    ...
    return (
        <div className="flex h-screen bg-gray-50">
            ...
            <div className="flex-1 overflow-auto">
                <div className="p-6">
                    <AdminNavbar title='Edit Event' user={user} toggleSidebar={toggleSidebar} />
                    <div className="flex w-full justify-center">
                        <div className="flex items-center mb-8">
                            ...
                            <div className="flex items-center">
                                <div className="bg-gray-200 text-gray-600 rounded-full w-6 h-6 flex items-center justify-center text-sm">2</div>
                                <span className="ml-2 text-gray-700 font-medium">Tickets</span>
                            </div>
                    ...
                    {
                        loading ? <EventFormSkeleton /> : <EventForm user={user as User} initialData={event} isEdit={true} />
                    }
                </div>
            </div>
        </div>
