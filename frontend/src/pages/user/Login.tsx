...
import { validateLogin } from '../../interfaces/validators/loginValidator'
import { googleAuth } from '../../store/actions/auth/googleAuth'
import { useAppDispatch } from '../../hooks/useAppDispatch'
import { Footer } from '../../components/partials/Footer'
import type { LoginFormState } from '../../interfaces/entities/FormState'
import type { LoginErrorState } from '../../interfaces/entities/ErrorState'
    ...
    const handleSubmit = async (e: React.ChangeEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (err instanceof Yup.ValidationError) {
                const errorMap: LoginErrorState = {};
                err.inner.forEach(e => {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-white">
            ...
            <div className="flex mt-25 w-full justify-center items-stretch px-2 py-2 min-h-[600px]">
                ...
                <div className="w-lg min-h-[600px] rounded-2xl md:rounded-tl-none md:rounded-bl-none shadow-2xl border-2 border-gray-200">
                    <div className="max-w-md p-8 mx-auto">
                        <div className="text-center mb-8">
                            <h2 className="text-3xl font-bold text-gray-900 mb-2">Welcome Back</h2>
                            <p className="text-gray-600">Log in to continue your journey with NexEvent</p>
                        </div>

                        <button
                            type="button"
                            onClick={() => dispatch(googleAuth())}
                            className="w-full flex items-center justify-center py-3 px-4 mb-6 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 cursor-pointer"
                        >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleForm}
                                    className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 ${errors.email ? 'border-red-500' : 'border-gray-300'
                                        }`}
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className={`w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200 cursor-pointer ${isLoading
