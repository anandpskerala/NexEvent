...
const BrowsePage = () => {
    ...
    useEffect(() => {
        const fetchRequest = async () => {
            setLoading(true);
            try {
                const eventRes = await getEventList(debouncedSearch, page, "", 25, false, false, payload.category, payload.eventType, payload.eventStatus, payload.startDate, payload.endDate, payload.sortBy);
                if (eventRes) {
