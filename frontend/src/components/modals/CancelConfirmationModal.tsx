...
export const CancelConfirmationModal: React.FC<DeleteConfirmationModalProps> = ({ isOpen, onClose, onConfirm, itemName }) => {
            ...
            <div className="bg-white rounded-lg shadow-xl z-10 w-96 max-w-full mx-4 overflow-hidden">
                ...
                <div className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <p className="text-gray-800 font-medium">Are you sure you want to cancel this item?</p>
                            {itemName && (
                                <p className="text-gray-500 text-sm mt-1">
                                    {itemName} will be permanently cancelled.
                                </p>
                            )}
                        </div>
                    </div>
                    <p className="text-gray-600 text-sm mb-4">
                        This action cannot be undone. All associated data will be permanently cancelled.
                    </p>
                </div>
